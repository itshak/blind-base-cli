...
PYINSTALLER_CMD = (
    ...
    "--runtime-hook packaging/pyi_rth_pydantic_purepython.py --hidden-import pydantic --hidden-import pydantic_settings --hidden-import tomlkit --hidden-import tkinter "
    "blindbase/menu.py"
)
