...
def main() -> None:
    ...
    PYINSTALLER_CMD = (
        ...
        "--hidden-import pydantic --hidden-import pydantic_settings --hidden-import pygame --hidden-import tomlkit --hidden-import urllib3 --hidden-import certifi --hidden-import typer "
        "blindbase/menu.py"
    )
